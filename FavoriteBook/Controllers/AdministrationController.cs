...
namespace FavoriteBook.Controllers
{
    ...
    public class AdministrationController : Controller
    {
        ...
        public AdministrationController(RoleManager<IdentityRole> roleManager, UserManager<User> userManager, IBookService service)
        {
        ...
        public async Task<IActionResult> EditUser(string id)
        {
            ...
            var userBooks = _service.GetBookByOwner(user.Id);
